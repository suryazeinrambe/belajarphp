...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  E-mail: <input required type="text" name="email" value="<?php echo $email;?>">
  ...
  Website: <input required type="text" name="website" value="<?php echo $website;?>">
  <span class="error"><?php echo $websiteErr;?></span>
  <br><br>


  Comment: <textarea required name="comment" rows="5" cols="40"><?php echo $comment;?></textarea>
  <br><br>
